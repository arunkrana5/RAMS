...
namespace COMMON
{
    public class ClsApplicationSetting
    {
        public static string GetWebConfigValue(string Key)
        {
            ...
            try
            {
                return new ConfigurationBuilder().AddJsonFile("appsettings.json").Build().GetSection("AppSetting")[Key].ToString();
            }
            catch (Exception ex)
            {
                httpContextAccessor.HttpContext.Response.WriteAsync("Key " + Key + "<br>" + ex.Message);
                httpContextAccessor.HttpContext.Response.HttpContext.Session.Clear();
            }
        ...
        public static bool SetSessionValue(string SessionName, string SessionValue)
        {
            ...
            try
            {
                ...
                {
                    httpContextAccessor.HttpContext.Session.SetString(SessionName, SessionValue);
                }
                else
                {
        ...
        public static string GetSessionValue(string sessionname)
        {
            ...
            string str = httpContextAccessor.HttpContext.Session.GetString(sessionname);
            if (httpContextAccessor.HttpContext.Session.GetString(sessionname) != null)
            {
                SessionValue = httpContextAccessor.HttpContext.Session.GetString(sessionname).ToString();
            }
            return SessionValue;
        }
        public static bool ClearSessionValues()
        {
            ...
            try
            {
                ...
                {
                    var SessionCount = httpContextAccessor.HttpContext.Session.Keys;
                    foreach (var item in SessionCount)
                    {
                    ...
                    //httpContextAccessor.HttpContext.Session.Remove();
                    //httpContextAccessor.HttpContext.Session.Abandon();
                }
