...
namespace COMMON
{
    public class ClsCommon
    {
        ...
        public static string GetWebsiteURL()
        {
            ...
            var address = string.Format("{0}://{1}", request.Scheme, request.Host);
            return address;
        }
        ...
        public static string ConnectionString()
        {
            ...
            return new ConfigurationBuilder().AddJsonFile("appsettings.json").Build().GetConnectionString("conn").ToString();
        }
